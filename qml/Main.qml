    ...
    Column {
            ...
            Row {
                ...
                Item {
                    ...
                    Rectangle { x: 4; y: 1; width: f(78); height: f(54); radius: f(10); color: "transparent"; border.color: green; border.width: 1
                        Text { anchors.centerIn: parent; text: "P2P°\nSRVR"; color: fg; font.family: "Helvetica Neue"; font.pixelSize: f(19); horizontalAlignment: Text.AlignHCenter; lineHeight: .78 }
                    }
                    Text { x: f(101); anchors.verticalCenter: parent.verticalCenter; text: "HV P2P  |  SRVR"; color: fg; font.family: "Helvetica Neue"; font.pixelSize: f(27); font.weight: Font.Medium }
                }
                ConnectionCard { width: (parent.width-f(360)-f(170)-f(40))/3; height: parent.height; title:"CTRL"; active:backend.ctrlConnected; line1: backend.ctrlConnected?"Connected":"Disconnected"; line2:"172.20.1.101" }
                ConnectionCard { width: (parent.width-f(360)-f(170)-f(40))/3; height: parent.height; title:"W1P"; active:backend.w1pConnected; line1: backend.w1pConnected?"Connected":"Disconnected"; line2:"172.20.1.102" }
        ...
        Item {
                                ...
                                Column { anchors.fill:parent; anchors.margins:f(12); spacing:f(3)
                                    Row { width:parent.width; height:f(35); spacing:f(4)
                                        ...
                                        Repeater { model:["Preset 1-5","Preset 6-10","Limits","System"]
                                            HVTab { width:(parent.width-f(148))/4; height:parent.height; text:modelData; selected:window.shortcutTab===index; onClicked:window.shortcutTab=index }
                                        }
                                    }
                                    ...
                                    Column {
                                        ...
                                        Row { width:parent.width;height:f(32); spacing:f(4); Text{width:f(105);anchors.verticalCenter:parent.verticalCenter;text:"Drive Mode";color:fg;font.pixelSize:f(13)} HVButton{width:f(65);height:parent.height;text:"Mode 1";selected:backend.activeDriveMode===0;onClicked:backend.setDriveMode(0)} HVField{width:(parent.width-f(105+65+65+16))/2;height:parent.height;text:backend.driveMode1Name;onEditingFinished:backend.renameDriveMode(0,text)} HVButton{width:f(65);height:parent.height;text:"Mode 2";selected:backend.activeDriveMode===1;onClicked:backend.setDriveMode(1)} HVField{width:(parent.width-f(105+65+65+16))/2;height:parent.height;text:backend.driveMode2Name;onEditingFinished:backend.renameDriveMode(1,text)} }
            ...
            Item {
                ...
                Column { anchors.fill:parent; spacing:f(8)
                    Item { width:parent.width; height:parent.height*0.58
                        Row { anchors.fill:parent; spacing:f(8)
                            ...
                            Panel { width:parent.cardWidth;height:parent.height
                                Column{anchors.fill:parent;anchors.margins:f(12);spacing:f(8);Text{width:parent.width;text:"LENS CALIBRATION";horizontalAlignment:Text.AlignHCenter;color:fg;font.pixelSize:f(18)}
                                    ...
                                    Row{width:parent.width;height:f(31);spacing:f(6);Text{width:f(42);anchors.verticalCenter:parent.verticalCenter;text:"Wide";color:fg;font.pixelSize:f(12)}HVField{width:parent.width-f(42+62+70+18);height:parent.height;text:"0"}Text{width:f(62);anchors.verticalCenter:parent.verticalCenter;text:"0.00 %";color:fg;font.pixelSize:f(12);horizontalAlignment:Text.AlignHCenter}HVButton{width:f(70);height:parent.height;text:"Cal"}}
                                    Row{width:parent.width;height:f(31);spacing:f(6);Text{width:f(42);anchors.verticalCenter:parent.verticalCenter;text:"Tele";color:fg;font.pixelSize:f(12)}HVField{width:parent.width-f(42+62+70+18);height:parent.height;text:"32767"}Text{width:f(62);anchors.verticalCenter:parent.verticalCenter;text:"100.00 %";color:fg;font.pixelSize:f(12);horizontalAlignment:Text.AlignHCenter}HVButton{width:f(70);height:parent.height;text:"Cal"}}
