...
class HVP2PBackend(QObject):
    ...
    def __init__(self, version="26.08.19.01", smoke_test: bool = False):
        super().__init__()
        ...
        # A7 carries five AUX bits in this integration revision. AUX1..AUX4 remain
        # compatible with the existing physical controller; AUX5 is generated by
        # CTRL-TS (or future hardware) through the same 16-bit packet.
